...
class Product Routes 
{
    ...
    // JIKA REQUEST METHOD GET DAN PATH MENGANDUNG '/api/product/' if ($method = 'GET' && strpos($path, '/api/product/') 0) {
    ...
    // JIKA REQUEST METHOD DELETE DAN PATH MENGANDUNG '/api/product/' if ($method 'DELETE' && strpos($path, '/api/product/') 0) {
